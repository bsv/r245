...
// пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ
// пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ, пїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ (пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ, пїЅпїЅпїЅпїЅ пїЅ пїЅ.пїЅ.),
// пїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ ftdi.
...
R245_API FT_STATUS R245_GetDevInfo(unsigned char num_dev, R245_DEV_INFO *info)
{
    FT_STATUS ft_status;
...
R245_API FT_STATUS R245_InitDev(unsigned char num_dev)
{
    FT_STATUS ft_status;
    FT_HANDLE ft_handle;
...
R245_API FT_STATUS R245_CloseDev(unsigned char num_dev)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
...
short int R245_CRCCount(short int init_crc, unsigned char * data, unsigned int len)
{
    short int crc;
        ...
        unsigned char *rx_data, unsigned char *rx_data_len)
{
    ...
    // Ошибка прошивки контролера
    // Для команды смены адреса CRC считается по сообщению
...
R245_API FT_STATUS R245_AuditEn(unsigned char num_dev,
        unsigned char addr_dev, unsigned char enable)
{
    ...
    return R245_PacketSend(info.ft_handle, addr_dev, AUDIT_EN, &enable, 1,
            NULL, &rx_data_len);
}

R245_API FT_STATUS R245_GetVersion(unsigned char num_dev,
        unsigned char addr_dev, unsigned char *version)
{
    unsigned char rx_data_len = 0;
    R245_DEV_INFO info;
...
R245_API FT_STATUS R245_GetNumTrans(unsigned char num_dev,
        unsigned char addr_dev, short unsigned int * num_trans)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, GET_NUM_TRANS, NULL,
            0, data, &rx_data_len);
...
R245_API FT_STATUS R245_GetDamp(unsigned char num_dev,
        unsigned char addr_dev, unsigned char num_ch, unsigned char * damp)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, cmd, NULL,
            0, damp, &rx_data_len);
    if(!ft_status)
    {
...
R245_API FT_STATUS R245_GetTime(unsigned char num_dev,
        unsigned char addr_dev, unsigned char num_ch, short int *time)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
...
R245_API FT_STATUS R245_ClearTrans(unsigned char num_dev, unsigned char addr_dev)
{
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, CLEAR_TRANS, NULL,
            0, NULL, &rx_data_len);
        ...
        unsigned char addr_dev, unsigned char num_ch, short int time)
{
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, cmd, data,
            2, NULL, &rx_data_len);
...
//    ch = 0 - пїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ
//    ch = 1 - пїЅпїЅпїЅпїЅпїЅ 1 пїЅпїЅпїЅпїЅпїЅпїЅпїЅ
//    ch = 2 - пїЅпїЅпїЅпїЅпїЅ 2 пїЅпїЅпїЅпїЅпїЅпїЅпїЅ
//    ch = 3 - пїЅпїЅпїЅпїЅпїЅпїЅ 1, 2 пїЅпїЅпїЅпїЅпїЅпїЅпїЅ
R245_API FT_STATUS R245_GetChan(unsigned char num_dev, unsigned char addr_dev, unsigned char * ch)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, READ_CFG, NULL,
            0, data, &rx_data_len);
...
R245_API FT_STATUS R245_SetChan(unsigned char num_dev,
        unsigned char addr_dev, unsigned char num_ch, unsigned char enable)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
...
R245_API FT_STATUS R245_GetTransact(unsigned char num_dev,
        unsigned char addr_dev, R245_TRANSACT * trans)
{
    FT_STATUS ft_status;
    R245_DEV_INFO info;
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, GET_TRANS, NULL,
            0, data, &rx_data_len);
...
R245_API FT_STATUS R245_SetTimeRTC(unsigned char num_dev, unsigned char addr_dev, R245_RTC * rtc_data)
{
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, SET_TIME, data,
            4, NULL, &rx_data_len);
...
// При смене адреса на линии должен быть только один считыватель
// Адрес в диапазоне от 1 до 254
...
R245_API FT_STATUS R245_SetDateRTC(unsigned char num_dev, unsigned char addr_dev, R245_RTC * rtc_data)
{
    ...
    ft_status = R245_PacketSend(info.ft_handle, addr_dev, SET_DATE, data,
            4, NULL, &rx_data_len);
